...
$$q_\sigma(\mathbf{x}_t \vert \mathbf{x}_0) = \mathcal{N}(\mathbf{x}_t; \sqrt{{\alpha_t}} \mathbf{x}_0, (1 - {\alpha}_t)\mathbf{I}), $$

可以推导出：

$$ q_\sigma(\mathbf{x}_{t-1} \vert \mathbf{x}_0) = \mathcal{N}(\mathbf{x}_{t-1}; \sqrt{{\alpha_{t-1}}} \mathbf{x}_0, (1 - {\alpha}_{t-1})\mathbf{I}), $$

则：

$$ \begin{aligned}
\mathbf{x}_{t-1} 
&= \sqrt{{\alpha_{t-1}}}\mathbf{x}_0 +  \sqrt{1 - {\alpha}_{t-1}}\cdot\mathbf{\epsilon}_{t-1} \\
...
因为 $$\mathbf{x}_t = \sqrt{{\alpha_t}}\mathbf{x}_0 + \sqrt{1 - {\alpha_t}}\mathbf{\epsilon}$$ ，所以 $$\mathbf{x}_0$$ 可以根据 $$\mathbf{x}_t$$ 计算出来：

$$ \begin{aligned}
\mathbf{x}_0=
\frac{1}{\sqrt{{\alpha_t}}}\left(\mathbf{x}_t- \sqrt{1 - {\alpha}_t}\cdot\mathbf{\epsilon}_{\theta}^{(t)}(\mathbf{x}_t)\right)
\end{aligned}, $$
