...
$$ \begin{aligned}
\mathbf{x}_{t-1} 
&= \sqrt{{\alpha_{t-1}}}\mathbf{x}_0 +  \sqrt{1 - {\alpha_{t-1}}}\cdot\mathbf{\epsilon}_{t-1} \\
&= \sqrt{\alpha_{t-1}}\mathbf{x}_0 +  \sqrt{1 - \alpha_{t-1} - \sigma_t^2} \cdot\mathbf{\epsilon}_t + \sigma_t\mathbf{\epsilon}  \\
\end{aligned}, $$
...
$$ \begin{aligned}
\mathbf{x}_0=
\frac{1}{\sqrt{{\alpha_t}}}\left(\mathbf{x}_t- \sqrt{1 - \alpha_t}\cdot\mathbf{\epsilon}_{\theta}^{(t)}(\mathbf{x}_t)\right)
\end{aligned}, $$
